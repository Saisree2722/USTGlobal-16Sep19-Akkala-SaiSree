...
public class TestK 
{
    public static void main(String[] args) 
    {
	  ...
	  al.remove(0);
	  System.out.println("Ater removing 0th index"+al);
	  al.remove(null);
	  System.out.println("After remving null" + al);
	  Double val = al.get(4);
	  System.out.println("Oject at 4th index "+val);
	  al.set(2,77.6);
	  System.out.println("After replacing 2nd index"+al);
	  al.clear();
	  System.out.println("After clear method"+al);
	  boolean b= al.contains(54.6);
	  System.out.println("After contains method "+b);
	  ...
	  System.out.println("Conatins all of al1 "+contain);
